...
set multiplot layout 4,1 title "Ramp1024 con ruido salt and pepper y filtro cero"
...
plot "mod2"  using 1 title 'Modificada'  with lines ls 2
##set xtics nomirror
##set tics scale 0 font ",8"
set xlabel "Descomposicion en el espectro de frecuencias"
plot "rec2"  using 1 title 'Recuperada'  with lines ls 3
