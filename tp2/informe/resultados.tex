...
\end{array}$
\end{center}
\caption{\textbf{Izquierda}: Im\'agen con ruido blanco con varianza 100, \textbf{Centro}: Recuperada con filtro promedio, \textbf{Derecha}: Recuperada aplicando filtro exponencial y promedio}
\label{fig:SinProm}
\end{figure}
