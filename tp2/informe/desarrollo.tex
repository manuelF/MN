...
reducir el tiempo de ejecuci\'on donde sea posible.
...
compilaci\'on y corrida de tests, para poder ser lo mas sistematicos posible.
...
Es de notar que la suma de los coeficientes ademas da 1, de modo que no se 
eliminen o agreguen valores, sino que se distribuya de forma pareja a sus vecinos.
