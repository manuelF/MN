...
proveniente de una distribuci\'on normal. Este tipo de ruido es muy frecuente e
importante en disciplinas como la fotograf\'ia. Consiste en un ruido totalmente
aleatorio, comprendido en todas las frecuencias.

 	Para cada punto se aplica el ruido de la siguiente manera:

	$$senal_ruidosa[i] = senal_original[i] + random(0, 10)$$
