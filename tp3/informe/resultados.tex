...
\end {center}
\caption{Suma de los elementos bajo la diagonal para 5000, 15000 y 30000 elementos
...
\end {center}
\caption{Promedio de los elementos bajo la diagonal para 5000, 15000 y 30000 elementos
en funcion de la cantidad de iteraciones de QR.}
\label{fig:PROM}
\end{figure}
