...
\begin{figure}
$\begin{array}{c}
\includegraphics[width=400pt]{plots/Caso1.png} \\
\includegraphics[width=400pt]{plots/Caso2.png}
\end{array}$
...
\begin{figure}
$\begin{array}{cc}
\includegraphics[width=220pt]{plots/Curves-Newton-Caso3.png} &
\includegraphics[width=220pt]{plots/Curves-Newton-Caso4.png} \\
\includegraphics[width=220pt]{plots/Curves-Newton-Caso5.png} &
\includegraphics[width=220pt]{plots/Curves-Newton-Caso6.png} \\
\includegraphics[width=220pt]{plots/Curves-Newton-Caso7.png} &
\includegraphics[width=220pt]{plots/Curves-Newton-Caso8.png} \\
